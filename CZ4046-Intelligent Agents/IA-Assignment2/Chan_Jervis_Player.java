...
public class Chan_Jervis_Player {
    ...
    class JervisChan extends Player {
        ...
        int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
            ...
            // Rule 5 -  “I will cooperate unless you defect 3 times in a row at which point I will defect forever.”
            if (n > 5) {
                if (oppHistory1[n - 3] == 1 && oppHistory2[n - 3] == 1 && oppHistory1[n - 2] == 1 && oppHistory2[n - 2] == 1 && oppHistory1[n - 1] == 1 && oppHistory2[n - 1] == 1) {
                    trigger = true;
                    return 1;
                }
                return 0;
    ...
    public static void main(String[] args) {
        Chan_Jervis_Player instance = new Chan_Jervis_Player();
